      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            className="relative max-h-[calc(100vh-3rem)] w-full max-w-[520px] overflow-y-auto rounded-[8px] bg-[#08090b] px-7 py-10 text-white shadow-[0_28px_90px_rgba(0,0,0,0.72)] sm:px-12 sm:py-12"
